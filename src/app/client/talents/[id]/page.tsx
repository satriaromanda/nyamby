...
export default async function ClientTalentProfilePage({
  params,
}: {
  ...
  const redirectPath = `/client/talents/${talent.id}`;
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 pt-8 pb-12">
      <div className="mb-4">
        <Link href="/client/talents" className="inline-flex items-center gap-2 text-sm text-surface-500 hover:text-surface-900 transition-colors">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <section className="lg:col-span-2 space-y-5">
          ...
          <div className="flex justify-end">
            <Link href={`/client/post-job?invite=${talent.id}`} className="btn-primary text-sm">
