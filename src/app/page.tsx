...
const copy = {
  id: {
    ...
    heroSubPrefix: "AI Career Companion yang membantu talenta Indonesia menemukan",
    typing: ["peluang terbaik.", "karier impian.", "skill yang tepat.", "masa depan cerah."],
    ctaTalent: "Mulai sebagai Talent",
    ctaClient: "Cari Talenta",
    reassurance: "Gratis · Tanpa kartu kredit · Escrow payment aman",
    demoJobTag: "Web Dev",
    ...
    steps: [
      { title: "Buat profil & upload portfolio", desc: "AI membaca CV dan portfolio-mu untuk memetakan skill secara otomatis." },
      { title: "AI mencarikan match terbaik", desc: "Bukan keyword matching — AI memahami konteks pengalaman dan tujuan kariermu." },
      { title: "Kerjakan project dengan escrow", desc: "Dana klien ditahan aman dan baru dirilis setelah hasil kerjamu disetujui." },
      { title: "Bertumbuh jadi karier", desc: "Skill gap analysis dan career path AI memandu langkah berikutnya." },
    ],
    bentoBadge: "Fitur",
    bentoTitleA: "Bukan sekadar",
    bentoTitleB: "marketplace.",
    bentoSub: "AI career companion yang bekerja untukmu di setiap langkah.",
    aiTitle: "AI Job Matching",
    aiDesc: "AI memahami CV, portfolio, dan tujuan kariermu — lalu menjelaskan kenapa kamu cocok.",
    aiAccuracy: "95% akurat",
    aiInsightLabel: "AI INSIGHT",
    aiInsight: "“Pengalaman React 3 tahun + portfolio e-commerce kamu sangat relevan dengan project ini. Highlight case study tokoku.id saat melamar.”",
    ...
    pricingDesc: "Benchmark rate pasar untuk skill-mu.",
    pricingUnit: "/project",
    careerTitle: "Career Path AI",
    careerDesc: "Dari nyambi pertama sampai karier profesional.",
    globalTitle: "Nyamby Global",
    globalDesc: "Ekspansi cross-border: klien Malaysia & internasional merekrut talenta Indonesia — pembayaran lintas negara tetap lewat escrow.",
    globalCta: "Jelajahi Nyamby Global",
    statsLabels: ["Rating talenta", "Talenta terverifikasi", "Match accuracy", "Project selesai"],
    ...
    testimonials: [
      { name: "Rizky Pratama", role: "Frontend Developer", avatar: "RP", color: "bg-blue-500", quote: "Dalam 2 minggu setelah daftar, saya langsung dapat 3 interview. AI matching-nya really works." },
      { name: "Siti Nurhaliza", role: "UI/UX Designer", avatar: "SN", color: "bg-pink-500", quote: "Skill Gap Analysis bikin saya sadar perlu belajar Figma. Sekarang punya 5 klien tetap." },
      { name: "Budi Santoso", role: "Fullstack Developer", avatar: "BS", color: "bg-emerald-500", quote: "Escrow payment bikin saya merasa aman. Dulu sering ditipu klien, sekarang semua terlindungi." },
      { name: "Dewi Anggraini", role: "Graphic Designer", avatar: "DA", color: "bg-amber-500", quote: "Smart pricing kasih tahu rate pasar — saya berhenti pasang harga terlalu murah." },
      { name: "Andi Wijaya", role: "Backend Developer", avatar: "AW", color: "bg-purple-500", quote: "AI reasoning-nya menjelaskan kenapa saya cocok. Melamar jadi lebih percaya diri." },
      { name: "Maya Puspita", role: "Content Designer", avatar: "MP", color: "bg-cyan-500", quote: "Career path AI memandu saya dari nyambi kecil-kecilan jadi freelancer full-time." },
    ],
    ...
    ctaBtnTalent: "Daftar sebagai Talent",
            ...
            <AnimateIn delay={300}>
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <Link
                  ...
                  className="btn-primary group flex items-center gap-2 px-7 py-3.5 rounded-full font-semibold text-sm glow-primary hover:-translate-y-0.5 transition-all active:translate-y-0"
                >
