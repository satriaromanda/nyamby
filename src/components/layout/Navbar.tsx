        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div className="relative group">
            <button className="flex items-center gap-1.5 text-sm font-medium text-surface-600 hover:text-surface-900 transition-colors py-2">
              Browse
              <Icon name="chevronDown" size={16} className="text-surface-500 group-hover:text-surface-900 transition-transform group-hover:-rotate-180 duration-200" />
            </button>
          ...
          <Link href="/perusahaan/tentang" className="flex items-center gap-2 text-sm font-medium text-surface-600 hover:text-surface-900 transition-colors py-2">
            <Icon name="info" size={16} className="text-surface-500 group-hover:text-surface-900 transition-colors" />
            About Us
          </Link>
          ...
          <a href="/#cara-kerja" className="flex items-center gap-2 text-sm font-medium text-surface-600 hover:text-surface-900 transition-colors py-2">
            <Icon name="book" size={16} className="text-surface-500 group-hover:text-surface-900 transition-colors" />
            Cara Kerja
          </a>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-left translate-y-2 group-hover:translate-y-0">
              <div className="w-[320px] bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-3 flex flex-col gap-1">
                <Link href="/fitur/ai-matching" className="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors group/item">
                ...
                <Link href="/fitur/career-path" className="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors group/item">
                ...
                <Link href="/fitur/skill-gap" className="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors group/item">
                ...
                <Link href="/fitur/escrow" className="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors group/item">
